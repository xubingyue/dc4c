...
#ifndef _H_worker_register_response_
#define _H_worker_register_response_
...
_WINDLL_FUNC int DSCSERIALIZE_JSON_COMPACT_worker_register_response( worker_register_response *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_COMPACT_worker_register_response( char *encoding , char *buf , int *p_len , worker_register_response *pst );
