...
#ifndef _H_query_workers_response_
#define _H_query_workers_response_
...
_WINDLL_FUNC int DSCINIT_query_workers_response( query_workers_response *pst );

_WINDLL_FUNC int DSCSERIALIZE_JSON_COMPACT_query_workers_response( query_workers_response *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_COMPACT_query_workers_response( char *encoding , char *buf , int *p_len , query_workers_response *pst );
