...
#ifndef _H_worker_notice_request_
#define _H_worker_notice_request_
...
_WINDLL_FUNC int DSCSERIALIZE_JSON_COMPACT_worker_notice_request( worker_notice_request *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_COMPACT_worker_notice_request( char *encoding , char *buf , int *p_len , worker_notice_request *pst );
