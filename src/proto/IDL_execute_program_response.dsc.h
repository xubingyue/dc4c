...
#ifndef _H_execute_program_response_
#define _H_execute_program_response_
...
_WINDLL_FUNC int DSCSERIALIZE_JSON_COMPACT_execute_program_response( execute_program_response *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_COMPACT_execute_program_response( char *encoding , char *buf , int *p_len , execute_program_response *pst );
