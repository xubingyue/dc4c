...
#ifndef _H_worker_notice_response_
#define _H_worker_notice_response_
...
{
	int	response_code ;
} worker_notice_response ;

_WINDLL_FUNC int DSCINIT_worker_notice_response( worker_notice_response *pst );

_WINDLL_FUNC int DSCSERIALIZE_JSON_COMPACT_worker_notice_response( worker_notice_response *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_COMPACT_worker_notice_response( char *encoding , char *buf , int *p_len , worker_notice_response *pst );
