...
#ifndef _H_deploy_program_request_
#define _H_deploy_program_request_
...
{
	char	program[ 64 + 1 ] ;
} deploy_program_request ;

_WINDLL_FUNC int DSCINIT_deploy_program_request( deploy_program_request *pst );

_WINDLL_FUNC int DSCSERIALIZE_JSON_COMPACT_deploy_program_request( deploy_program_request *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_COMPACT_deploy_program_request( char *encoding , char *buf , int *p_len , deploy_program_request *pst );
