...
#ifndef _H_execute_program_request_
#define _H_execute_program_request_
...
_WINDLL_FUNC int DSCSERIALIZE_JSON_COMPACT_execute_program_request( execute_program_request *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_COMPACT_execute_program_request( char *encoding , char *buf , int *p_len , execute_program_request *pst );
