...
#ifndef _H_query_workers_request_
#define _H_query_workers_request_
...
typedef struct
{
	...
	int	bits ;
	int	count ;
} query_workers_request ;

_WINDLL_FUNC int DSCINIT_query_workers_request( query_workers_request *pst );

_WINDLL_FUNC int DSCSERIALIZE_JSON_COMPACT_query_workers_request( query_workers_request *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_COMPACT_query_workers_request( char *encoding , char *buf , int *p_len , query_workers_request *pst );
