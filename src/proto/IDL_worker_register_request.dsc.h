...
#ifndef _H_worker_register_request_
#define _H_worker_register_request_
...
_WINDLL_FUNC int DSCINIT_worker_register_request( worker_register_request *pst );

#include "fasterjson.h"

_WINDLL_FUNC int DSCSERIALIZE_JSON_COMPACT_worker_register_request( worker_register_request *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_COMPACT_worker_register_request( char *encoding , char *buf , int *p_len , worker_register_request *pst );
