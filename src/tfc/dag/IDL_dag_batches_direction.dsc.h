...
#ifndef _H_dag_batches_direction_
#define _H_dag_batches_direction_
...
typedef struct
{
	...
	char	to_batch[ 64 + 1 ] ;
} dag_batches_direction ;

_WINDLL_FUNC int DSCINIT_dag_batches_direction( dag_batches_direction *pst );
